    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnLogin.Click
        ...
        Try
            ...
            Else
                ...
                Try
                    If ExtendedUtil.NOINT(roomNo, gname) = 1 Then

                        Session("Message") = Messaging.noauth
                        Response.Redirect("~/UserError.aspx")
                        Return
                    End If
                Catch ex As Exception
                ...
                res = ExtendedUtil.getpwd(roomNo, gname)
                ...
                Try
                    ...
                    If res = "-1" Or res = "" Then
                        ...
                        Dim GT As DataTable
                        GT = ExtendedUtil.getGuestDetails(roomNo, gname)

                        Dim regcode As String = ""
                        Dim guestname1 As String = ""
                        Dim coupon As String = ""
                        regcode = GT.Rows(0)(3)
                        guestname1 = GT.Rows(0)(2)

                        coupon = ExtendedUtil.getAcode(regcode)

                        Try
                            ' ob.write2LogFile("Password-" & roomNo, "Regcode=" & regcode & "Name=" & guestname1 & "Res=" & res & "old coupon=" & coupon)

                            If coupon = "-1" Then
                                accessCode1 = CouponUtil.CreateCoupons(1, "ITC")

                                ExtendedUtil.IssueAccessCodeToGuest("MSPL", "", accessCode1, roomNo, guestname1, regcode)

                                ' ob.write2LogFile("Password-" & roomNo, "Regcode=" & regcode & "Name=" & guestname1 & "Res=" & res & "new coupon=" & accessCode1)
                        ...
                        Try
                            Response.Redirect("password_reset.aspx?" & URL & "&ln=" & gname & "&rm=" & roomNo & "&acc=" & accessCode1)

                            'Response.Redirect("mifilogin.aspx?" & url & "&plan=" & planId & "&ln=" & res & "&rm=" & roomno)
                        Catch ex As Exception
                    ...
                    Else
                        ...
                        Response.Redirect("password.aspx?" & URL & "&ln=" & gname & "&rm=" & roomNo & "&acc=" & accessCode1)
                ...
                Catch ex As Exception
                    ob.write2LogFile("Err1", ex.Message)
                End Try
