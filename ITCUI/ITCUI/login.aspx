<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/SHMaster.Master"
    CodeBehind="login.aspx.vb" Title="ITC Hotels" Inherits="ITCUI.login" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="bg">
        ...
        <div class="instructions">
            ...
            <p>
                <label >
                    Your Macaddress<%--<span style="color: #FF0000; font-size: 15px; font-weight: bold; font-family: Verdana, Arial, Helvetica, sans-serif;
...
<p style="text-align: left; clear: both; padding-top: 10px;">
        ...
        <div class="access_code">
            ...
            <p>
                ...
                <asp:Button ID="Button1" Visible ="false"  runat="server" Text="" CssClass="button" />
            </p>
        </div>
    </div>
</asp:Content>
<asp:Content ID="ScriptContent" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="server">
    ...
    <script src="PageScript/Instruction2.js" type="text/javascript"></script>
